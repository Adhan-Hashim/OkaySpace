            ...
            <div ref={containerRef} style={{
                ...
                <div ref={formRef} style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                    ...
                    <div style={{ marginBottom: '2rem' }}>
                        ...
                        }}>Access your space to explore, share & heal</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                        ...
                        <button
                            ...
                            style={{
                                ...
                                justifyContent: 'center',
                                gap: '0.5rem',
                                boxShadow: loading ? 'none' : '0 10px 30px rgba(244, 139, 71, 0.3)'
                            }}
                            onMouseEnter={(e) => !loading && (e.target.style.background = '#e07a3a')}
