  ...
  return (
    <AuthProvider>
      <div className="app-layout">
        <Navigation />
        <main className="main-content" style={{ marginBottom: showFooter ? 'var(--footer-h)' : 0, borderRadius: showFooter ? '0 0 50px 50px' : 0, boxShadow: showFooter ? '0px 20px 50px rgba(0,0,0,0.2)' : 'none' }}>
